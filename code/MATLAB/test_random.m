...
nr2 = -1;
    ...
    H=zeros(1,hf);
        ...
        for t=1:1:simtime
            ...
            if MR1(1, 86400*(d)+h*3600+mod(t,3600)+1) == 0
                kkk=1;
            
            elseif MR1(1, 86400*(d)+h*3600+mod(t,3600)+1) == 1
                nr1 = nr1 + 1;
            ...
            if MR2(1, 86400*(d)+h*3600+mod(t,3600)+1) == 0
                
            elseif MR2(86400*(d)+h*3600+mod(t,3600)+1) == 1
                 nr2 = nr2 - 1;
...
subplot(2,1,1);
area (TxH);
title('Direction Airolo');
xlabel('Car Number');
ylabel('time to go through the pass [s]');

subplot(2,1,2);
area (TxD);
title('Direction Goeschenen');
xlabel('Car Number * (-1)');
ylabel('time to go through the pass [s]');
